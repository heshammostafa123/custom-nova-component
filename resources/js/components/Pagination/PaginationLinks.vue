  ...
  <nav class="rounded-b-lg font-bold flex items-center">
    ...
    <div class="flex text-sm ml-auto">
      ...
      <button
        ...
        :class="{
          'text-gray-500': hasPreviousPages,
          'text-gray-500 disabled': !hasPreviousPages || linksDisabled,
        }"
        rel="prev"
        @click.prevent="selectPreviousPage()"
        dusk="previous"
      >
        <!-- &lsaquo; --> <span>Previous</span>
      </button>
      ...
      <button
        ...
        :class="{
          ...
          'text-gray-500 bg-gray-50 dark:bg-gray-700 active': page === n,
        }"
      ...
      <button
        ...
        :class="{
          ...
          'text-gray-500 disabled': !hasMorePages || linksDisabled,
        }"
        rel="next"
        @click.prevent="selectNextPage()"
        dusk="next"
      >
        <!-- &rsaquo; --> <span>Next</span>
      </button>
