<template>
  <div>
    ...
    />
    <Dropdown v-if="filters.length" dusk="filter-selector" :should-close-on-blur="false">
    <Button
    ...
    <template #menu>
      <DropdownMenu width="520" dusk="filter-menu" class="custom-filter-dropdown">
        <ScrollWrap :height="350" class="bg-white dark:bg-gray-900">
          ...
          >
            ...
            <!-- Custom Filters -->
            <div class="field-wrapper" v-for="filter in filters" :key="filter.name">
              <component
                :is="filter.component"
            ...
            <div v-if="filtersAreApplied" class="bg-gray-100 custom-reset-filter">
              <button
